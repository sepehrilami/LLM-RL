...
'''For the NR scenario, we created this separate file for vizualization since we saw
   an outlier in the NR results and needed to rerun it to make the results more accurate'''
